    ...
    children:[
      ...
      // },
      {
        ...
        loadChildren: () => import('../pages/instruments/instruments-list/instruments-list.module')
            .then( m => m.InstrumentsListPageModule)
      },
      {
        path: COMPONENT.INSTRUMENTS+'/:id',
        loadChildren: () => import('../pages/instruments/instruments-detail/instruments-detail.module')
            .then( m => m.InstrumentsDetailPageModule)
      },
      {
        path: '',
